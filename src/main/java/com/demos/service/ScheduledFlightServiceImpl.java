...
import com.demos.dao.ScheduleDao;
import com.demos.dao.ScheduledFlightDao;
...
public class ScheduledFlightServiceImpl implements ScheduledFlightService {
	...
	public ScheduledFlight modifyScheduledFlight(ScheduledFlight scheduleFlight) {
		/*
		 * ScheduledFlight updateScheduleFlight =
		 * dao.findById(scheduleFlight.getScheduleFlightId()).get(); Schedule
		 * updateSchedule =
		 * scheduleDao.findById(scheduleFlight.getSchedule().getScheduleId()).get();
	...
	public String removeScheduledFlight(BigInteger flightId) throws RecordNotFoundException {
		...
		return "Scheduled flight with ID " + flightId + " is removed";
	}
